...
def main():
    ...
    st.title("Smart Wealth Management:")
    
    df = pd.read_csv('./MF_India.csv')
    chart_data=pd.crosstab(index=df['category'],columns=df['risk_level'])
